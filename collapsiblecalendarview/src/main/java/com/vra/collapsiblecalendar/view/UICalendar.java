package com.vra.collapsiblecalendar.view;
...
public abstract class UICalendar extends ScrollView {
    ...
    public UICalendar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        clEntireTextView.setOnTouchListener((view, motionEvent) -> expandIconView.performClick());
    ...
    public void setAttributes(TypedArray attrs) {
        ...
        this.todayItemBackgroundDrawable = todayItemBackgroundDrawable != null ? todayItemBackgroundDrawable : ContextCompat.getDrawable(getContext(), R.drawable.circle_stroke_background);
        ...
        this.selectedItemBackgroundDrawable = selectedItemBackgroundDrawable != null ? selectedItemBackgroundDrawable : ContextCompat.getDrawable(getContext(), R.drawable.circle_solid_background);

        Drawable buttonLeftDrawable = attrs.getDrawable(R.styleable.UICalendar_buttonLeft_drawable);
        this.buttonLeftDrawable = buttonLeftDrawable != null ? buttonLeftDrawable : ContextCompat.getDrawable(getContext(), R.drawable.left_arrow_icon);

        Drawable buttonRightDrawable = attrs.getDrawable(R.styleable.UICalendar_buttonRight_drawable);
        this.buttonRightDrawable = buttonRightDrawable != null ? buttonRightDrawable : ContextCompat.getDrawable(getContext(), R.drawable.right_arrow_icon);
